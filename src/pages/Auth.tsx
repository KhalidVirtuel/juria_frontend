...
import { Mail, Lock, User, Eye, EyeOff, AlertCircle, X, Building2, Briefcase } from 'lucide-react';
...
const Auth: React.FC = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorModal(error.response?.data?.error || "Une erreur est survenue. Veuillez réessayer.");
    } finally {
      setLoading(false);
    }
  };
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input id="firstName" type="text" value={firstName}
                      ...
                      className="pl-10 h-11 border-gray-300 focus:border-[#0187DA] focus:ring-[#0187DA]" placeholder="Jean" />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input id="lastName" type="text" value={lastName}
                      ...
                      className="pl-10 h-11 border-gray-300 focus:border-[#0187DA] focus:ring-[#0187DA]" placeholder="Dupont" />
                  </div>
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <Input id="lawFirm" type="text" value={lawFirm}
                    ...
                    className="pl-10 h-11 border-gray-300 focus:border-[#0187DA] focus:ring-[#0187DA]" placeholder="Cabinet Dupont & Associés" />
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input id="signupEmail" type="email" value={email}
                    ...
                    className="pl-10 h-11 border-gray-300 focus:border-[#0187DA] focus:ring-[#0187DA]" placeholder="votre@email.com" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <Input id="signupPassword" type={showPassword ? 'text' : 'password'} value={password}
                    ...
                    className="pl-10 pr-10 h-11 border-gray-300 focus:border-[#0187DA] focus:ring-[#0187DA]" placeholder="••••••••" />
