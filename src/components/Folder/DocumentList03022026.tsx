          ...
          <CardTitle className="text-lg flex items-center gap-2">
            <Dialog open={isAddDialogOpen || !!editingDocument} onOpenChange={(open) => {
              ...
              <Button 
                ...
                className="flex items-center gap-2 px-6 py-3 text-sm font-medium border border-purple-600 transition-colors text-purple-600 bg-white hover:bg-purple-600 hover:text-white ml-2"
              >
            ...
            {documents.length > 0 && (
              <>
                ...
                >
                  ...
                  Filtrer
                  {filterText && <span className="ml-2">({filteredDocuments.length})</span>}
                </Button>
