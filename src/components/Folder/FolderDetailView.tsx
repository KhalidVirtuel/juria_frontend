          ...
          <Card className="h-full flex flex-col border-none shadow-none mx-auto">
            ...
            <CardHeader className="flex-row items-center justify-end space-y-0 pb-4 mr-10">
                    ...
                    <Button
                      ...
                      className={cn(
                        "h-9 w-9 rounded-full transition-colors border border-mezin",
                        filterText 
                    ...
                    {/* Bouton Réinitialiser - Afficher toutes les conversations */}
      ...
      <Dialog open={showFilterPopup} onOpenChange={setShowFilterPopup}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Recherchez des conversations par leur titre
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="relative">
              <Input
                type="text"
                placeholder="Entrez le titre de conversation..."
                value={filterText}
      ...
      <Dialog open={showSearchPopup} onOpenChange={setShowSearchPopup}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Recherchez dans les titres et messages des conversations
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="relative">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                ...
                className="bg-accent hover:bg-mezin text-white"
              >
                Appliquer
              </Button>
            </div>
