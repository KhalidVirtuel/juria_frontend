...
const AddLegalDocumentDialog: React.FC<AddLegalDocumentDialogProps> = ({
  open,
  onOpenChange,
  onSubmit,
  uploading = false,
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="name"
              placeholder="Ex: Code pénal marocain 2024"
              value={name}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="description"
              placeholder="Ex: Ensemble des lois définissant les infractions et fixant les peines applicables au Maroc"
              value={description}
...
export default AddLegalDocumentDialog;