...
import { Plus, X,Send, Search, FileText, MessageSquare, Save, Sparkles, LayoutGrid, ChevronRight, Brain, ShieldCheck, Gavel, AlertTriangle, Compass, Handshake, CheckSquare, Heart, Building2, Briefcase, Home, Car, Users, Clock, ClipboardList, Scale, PenTool } from 'lucide-react';
...
const ChatSection = ({ onNavigateToWorkflow }: ChatSectionProps): JSX.Element => {
  ...
  // ✅ Mettre à jour le textarea quand l'animation est terminée
  useEffect(() => {
        ...
        (step: StreamStep) => {
          ...
          if (step.step && stepMap[step.step]) {
            setStreamingSteps(prev => {
              ...
              return existing
                ? prev.map(s => s.id === newStep.id ? { ...s, ...newStep } : s)
                : [...prev, newStep];
            });
          }
        }
              ...
              <div className="w-full max-w-2xl mx-auto text-center">
                <div className="relative max-w-3xl mx-auto mb-2">
                  ...
                  <div className="relative liquid-glass-container">
                    <div className="relative flex items-start gap-0 p-2 pt-0">
                          ...
                          <div className="space-y-1">
                            ...
                            <div className="border-t border-border mt-2 pt-2">
                              <button
                                onClick={() => {
                                  setWorkflowMenuOpen(false);
                                  onNavigateToWorkflow?.(); // ← Tu peux ajouter ton handler ici
                                }}
                      ...
                      <Button 
                        ...
                        size="icon" 
                        className="h-10 w-10 flex-shrink-0 self-center rounded-full bg-accent hover:bg-mizen text-accent-foreground" 
