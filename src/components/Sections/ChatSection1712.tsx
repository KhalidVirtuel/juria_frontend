...
const ChatSection: React.FC = () => {
  ...
  const handleStartNewChat = async () => {
    ...
    try {
      ...
      // ⏳ ÉTAPE 3 : Petite pause pour que l'utilisateur voie son message
      ...
      // 🧹 Nettoyer le message optimiste en cas d'erreur
      setOptimisticMessage(null);
    } finally {
                  ...
                  <div className="relative liquid-glass-container">
                    ...
                    <div className="relative flex items-start gap-2 py-1 px-2">
                      ...
                      <Button 
                        ...
                        size="icon" 
                        className="h-10 w-10 flex-shrink-0 self-center rounded-full bg-accent hover:bg-accent/90 text-accent-foreground" 
