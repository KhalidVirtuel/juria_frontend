...
const ChatSection: React.FC = () => {
  ...
  // ✅ Callback pour transcription vocale (utilisé par ChatContainer ET écran vide)
              ...
              <div className="w-full max-w-2xl mx-auto text-center">
                <div className="relative max-w-3xl mx-auto mb-2">
                  ...
                  <div className="relative liquid-glass-container">
                    <div className="relative flex items-start align-middle gap-1 p-2 pt-0">
                      ...
                      <Button type="button" onClick={handleOpenUpload} size="icon" variant="ghost" 
                        className="h-10 w-10 flex-shrink-0 self-end text-foreground hover:text-white hover:bg-mezin">
                      ...
                      <textarea
                        ...
                        disabled={isTyping || isTypingTranscript}
                        style={{ minHeight: '46px', maxHeight: '200px', height: '46px !important' }}
                      />
                      <Button onClick={handleStartNewChat} size="icon" 
                        className="h-10 w-10 flex-shrink-0 self-end rounded-full bg-accent hover:bg-mezin text-accent-foreground" 
